...
import { Search, Plus, Filter, Edit2, Trash2, FileText, Eye } from 'lucide-react'; // 1. เพิ่ม Eye icon
import ProjectModal from './ProjectModal';
import ProjectTimelineModal from './ProjectTimelineModal'; // 2. Import Modal Timeline ที่เพิ่งสร้าง
...
const ProjectList: React.FC = () => {
    ...
    const handleDelete = (id: number) => {
        if (window.confirm('คุณแน่ใจหรือไม่ที่จะลบโครงการนี้? การกระทำนี้ไม่สามารถย้อนกลับได้')) {
            deleteProject(id);
        }
    };
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col md:flex-row gap-4">
                ...
                <div className="flex items-center space-x-2 min-w-[200px]">
                    ...
                    >
                        ...
                        <option value="HOLD">รอตรวจสอบ (HOLD)</option>
            ...
            {/* 6. Modal สำหรับ Timeline */}
            {isTimelineOpen && viewingProject && (
